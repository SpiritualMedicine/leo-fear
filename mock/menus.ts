      ...
      [
        ...
        req.can(Role.staff) && {
          ...
          children: [
            ...
            req.can(Role.admin) && {
              id: "610159148224d543ae4e05b7",
              label: "Page",
              name: "new",
              params: { type: "page" },
            },
            req.can(Role.admin) && {
              id: "610159148224d543ae4e05b8",
              label: "User",
              name: "users",
            },
          ].filter(Boolean),
    ...
    [
      ...
      req.can(Role.staff) && {
        ...
        children: [
          ...
          {
            id: "610159148224d543ae4e05ca",
            label: "New post",
            name: "new",
            params: { type: "blog" },
          },
          {
            id: "610159148224d543ae4e05cb",
            label: "Categories",
            name: "terms",
      ...
      req.can(Role.staff) && {
        ...
        children: [
          {
            id: "610159148224d543ae4e05ce",
            label: "All pages",
            name: "posts",
            params: { type: "page" },
          },
          req.can(Role.admin) && {
            id: "610159148224d543ae4e05cf",
            label: "New page",
            name: "new",
            params: { type: "page" },
          },
      ...
      req.can(Role.admin) && {
        ...
        children: [
          ...
          {
            id: "610159148224d543ae4e05da",
            label: "Customization",
            name: "customize",
          },
          { id: "610159148224d543ae4e05db", label: "Widgets", name: "widgets" },
          {
            id: "610159148224d543ae4e05dc",
            label: "Navigation",
            name: "navigation",
          },
        ].filter(Boolean),
      ...
      req.can(Role.admin) && {
        ...
        children: [
          {
            id: "610159148224d543ae4e05de",
            label: "Installed plugins",
            name: "plugins",
          },
          {
            id: "610159148224d543ae4e05df",
      ...
      req.can(Role.staff) && {
        ...
        children: [
          ...
          {
            id: "610159148224d543ae4e05e7",
            label: "Reading",
            name: "options",
            params: { type: "reading" },
          },
          {
            id: "610159148224d543ae4e05e8",
            label: "Discussion",
            name: "options",
            params: { type: "discussion" },
          },
          {
            id: "610159148224d543ae4e05e9",
            label: "Media",
            name: "options",
            params: { type: "media" },
          },
          req.can(Role.admin) && {
            id: "610159148224d543ae4e05ea",
            label: "Permalink",
            name: "options",
